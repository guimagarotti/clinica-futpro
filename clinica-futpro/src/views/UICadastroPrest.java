...
public class UICadastroPrest extends javax.swing.JFrame {
    ...
    private void cadastraPrestador(CadastroPrestador novoPrestador) {
        ...
        try {
            this.conectar.insertSQL(
                    "INSERT INTO tb_cadastroPrest VALUES ("
                    + "'" + novoPrestador.getId() + "',"
    ...
    private void buscaPrestador(CadastroPrestador novoPrestador) {
        ...
        try {
            this.conectar.executarSQL(
                    "SELECT " + "nome," + "email," + "senha," + "profissao" + " FROM " + "tb_cadastroPrest"
    ...
    public void atualizaPrestador(CadastroPrestador novoPrestador) {
        ...
        try {
            this.conectar.updateSQL(
                    "UPDATE tb_cadastroPrest SET nome="
    ...
    public void removePrestador(CadastroPrestador novoPrestador) {
        ...
        try {
            this.conectar.updateSQL(
                    "DELETE FROM tb_cadastroPrest WHERE cpf = '" + consultaCpf + "';"
            );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UICadastroPrest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UICadastroPrest().setVisible(true);
            }
        });
    }
